...
Supports the [Cursor](https://www.cursor.com/) (v0.43.6+), and [GitHub Copilot](https://github.com/features/copilot) (v1.300.0+) IDEs, as well as [Claude Code](https://www.claude.com/product/claude-code) (v1.0.27+), [Cursor CLI](https://cursor.com/cli) (v2025.09.18-7ae6800+) and [Codex CLI](https://www.openai.com/codex/cli/) (v0.42.0+) via our CLI.
